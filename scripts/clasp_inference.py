...
from clasp import CLASPModel, ProjectionHead, SimpleProjectionHead, load_perch_model, SpatiotemporalEncoder, Identity
import librosa
import json
...
if __name__ == '__main__':
    ...
    prediction_save_path = str_deep + "_projection_head_" + str(num_epochs) + "_epoch_lr_" + str(learning_rate) + use_st_string + "_d_" + str(embedding_dim) + "_clasp_" + subset + "_mult_predictions.pkl"
    ...
    text_list = generate_text_descriptions(torch.arange(14795))
